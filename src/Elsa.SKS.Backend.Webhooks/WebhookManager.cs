...
using WebhookMessage = Elsa.SKS.Backend.DataAccess.Entities.WebhookMessage;

namespace Elsa.SKS.Backend.Webhooks
{
    public class WebhookManager : IWebhookManager
    {
        ...
        private async Task SendParcelInfosToClient(WebhookMessage body, string subscriberUrl)
        {
            ...
            var dto = _mapper.Map<Backend.Webhooks.DTOs.WebhookMessage>(body);
